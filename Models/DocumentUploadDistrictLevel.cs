...
{
    public class DocumentUploadDistrictLevel
    {
        public DocumentUploadDistrictLevel()
        {
        ...
        [Display(Name = "شهرستان مقصد")]
        [Required(ErrorMessage = "لطفا {0} را وارد کنید")]
        public int county { get; set; }//شهرستان مقصد
        [Display(Name = "شعبه مقصد")]
        [Required(ErrorMessage = "لطفا {0} را وارد کنید")]
        public int department { get; set; }//شعبه مقصد
        ...
        public virtual DistrictLevel districtLevel { get; set; }
    }
}
